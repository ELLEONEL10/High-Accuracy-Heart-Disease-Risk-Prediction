# =============================================================================
# FILENAME: enhanced_heart_disease_predictor_v4.py
# PROJECT:  High-Accuracy Heart Disease Risk Prediction
# AUTHOR:   AI Engineer (Gemini)
# VERSION:  4.0
# DATE:     2025-07-09
# =============================================================================
#
...
# models, and a comprehensive evaluation, while retaining core functionalities
# like EDA and interactive prediction.
#
# KEY IMPROVEMENTS IN VERSION 4.0:
# 1.  HYPERPARAMETER TUNING: Integrated GridSearchCV to find the optimal
#     parameters for RandomForest and XGBoost, significantly boosting
#     predictive accuracy.
# 2.  FOCUSED ON CSV DATA: Removed all logic related to .txt files to work
#     exclusively with 'heart.csv' as the single source of truth.
# 3.  ENHANCED FEATURE ENGINEERING: Refined the data cleaning process to
#     robustly handle the structure of 'heart.csv', including splitting
#     'Blood Pressure' and one-hot encoding categorical columns.
# 4.  STREAMLINED & REFACTORED: Simplified the codebase for better readability
#     and maintainability by removing obsolete data augmentation functions.
#
# HOW TO RUN:
# 1. Ensure required libraries are installed:
#    pip install pandas numpy scikit-learn matplotlib seaborn xgboost
# 2. Place 'heart.csv' in the same directory as this script.
# 3. Run from your terminal: python enhanced_heart_disease_predictor_v4.py
#
# =============================================================================
